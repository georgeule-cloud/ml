...
def fetch_rating(movie_id):
    ...
    data = requests.get(url)
    data = data.json()
    rating = round((data['popularity']/20),1)
    return rating
...
if st.button('Muestrame las recomendaciones'):
    ...
    with col3:
        ...
        st.write(str(recommended_movie_ratings[2]), "/6 ★")
